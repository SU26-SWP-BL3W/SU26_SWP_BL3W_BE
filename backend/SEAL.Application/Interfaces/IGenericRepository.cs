...
namespace SEAL_Application.Interfaces
{
    ...
    public interface IGenericRepository<T> where T : class
    {
        ...
        public PagedResult<TResult> FindWithPaging<TResult>(
            Expression<Func<T, bool>>? predicate,
            Func<IQueryable<T>, IOrderedQueryable<T>>? orderBy,
            Expression<Func<T, TResult>> selector,
            int pageNumber,
        ...
        /// <summary>
        /// Finds records with pagination and maps them to a DTO asynchronously.
        /// </summary>
        Task<PagedResult<TResult>> FindWithPagingAsync<TResult>(
            Expression<Func<T, bool>>? predicate,
            Func<IQueryable<T>, IOrderedQueryable<T>>? orderBy,
            Expression<Func<T, TResult>> selector,
            int pageNumber,
        ...
        /// <summary>
        /// Update multiple records from the database asynchronously.
        /// </summary>
        /// <param name="entities">The list of records to update.</param>
        /// <returns>A task that represents the asynchronous operation.</returns>
