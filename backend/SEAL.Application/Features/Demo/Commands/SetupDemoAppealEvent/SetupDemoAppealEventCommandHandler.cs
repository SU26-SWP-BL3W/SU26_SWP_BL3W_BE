...
namespace SEAL_Application.Features.Demo.Commands.SetupDemoAppealEvent
{
    public class SetupDemoAppealEventCommandHandler : IRequestHandler<SetupDemoAppealEventCommand, Result<BaseResponse<bool>>>
    {
        ...
        public async Task<Result<BaseResponse<bool>>> Handle(SetupDemoAppealEventCommand request, CancellationToken cancellationToken)
        {
            ...
            // Teams
            var team1 = new Team { Event = event3, Name = "Team Phúc Khảo 1", Status = TeamStatus.Registered, TrackId = track3.Id };
            ...
            var team2 = new Team { Event = event3, Name = "Team Phúc Khảo 2", Status = TeamStatus.Registered, TrackId = track3.Id };
            ...
            var submit1 = new SubmitResult
            {
                ...
                TrackId = track3.Id,
                RoundId = round3.Id,
                SubmissionUrl = "https://github.com/microsoft/vscode",
            ...
            var submit2 = new SubmitResult
            {
                ...
                TrackId = track3.Id,
                RoundId = round3.Id,
                SubmissionUrl = "https://github.com/golang/go",
                RepoUrl = "https://github.com/golang/go",
                DemoUrl = "https://go.dev",
                SlideUrl = "https://docs.google.com",
